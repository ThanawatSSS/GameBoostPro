...
& $csc /nologo /target:winexe `
    ...
    /reference:System.Drawing.dll `
    /reference:System.Windows.Forms.dll `
    /resource:"$dist\GameBoostPro.exe",GameBoostPro.Payload.exe `
    /resource:"$root\README.txt",GameBoostPro.Readme.txt `
...
$zip = Join-Path $dist 'GameBoostPro-Portable-v3.0.0.zip'
